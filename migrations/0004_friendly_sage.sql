...
ALTER TABLE "usersToRoles" ADD CONSTRAINT "usersToRoles_applicationId_roleId_userId" PRIMARY KEY("applicationId","roleId","userId");

DO $$ BEGIN
 ALTER TABLE "usersToRoles" ADD CONSTRAINT "usersToRoles_applicationId_application_id_fk" FOREIGN KEY ("applicationId") REFERENCES "application"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
